...
## V118.0 RC3.11.1 Safe Rebuild
- RC3.10.1 runtime and Telegram startup path are preserved.
- Command Health is an isolated, fail-open sidecar projection.
- Sidecar failure must never terminate startup or mutate authoritative certification.
- New features attach laterally; core runtime/polling code remains protected.
